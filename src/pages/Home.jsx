    ...
    <>
      <section className="h-[400px] min-w-[320px] md:h-[500px] bg-[#f6f7fb] flex justify-center w-full relative p-4">
        ...
        <div className="min-w-[300px] max-w-[80%] grid  justify-center items-center gap-1 absolute bottom-8">
          <h1 className=" font-bold sm:text-4xl text-3xl leading-tight font-sf text-center tracking-tight">
      ...
      <section className="text-white bg-black flex flex-col w-full relative pb-11 p-4 ">
        <div className="  w-full grid gap-4 py-16 ">
          <h1 className="font-bold md:text-4xl text-3xl justify-center lg:text-center text-left leading-tight font-sf tracking-tight">
            <p className=" leading-tight justify-center px-1 lg:flex grid sm:text-center text-left  font-medium poppins-regular">
